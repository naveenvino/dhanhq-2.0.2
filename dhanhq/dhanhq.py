...
class dhanhq:
    ...
    def quote_data(self, securities):
        ...
        Returns:
            dict: The response containing full packet including market depth, last trade, circuit limit, OHLC, OI
            volume data.
        """
        try:
    ...
    def option_chain(self, under_security_id, under_exchange_segment, expiry):
        ...
        Returns:
            dict: The response containing Open Interest (OI), Greeks, Volume, Last Traded Price, Best Bid/Ask,
            and Implied Volatility (IV) across all strikes for the specified underlying.
        """
        try:
    ...
    def expiry_list(self, under_security_id, under_exchange_segment):
        ...
        Returns:
            dict: The response containing list of dates for which option expiries are present
            for the specified underlying instrument.
        """
        try:
